...
**价值观**：导航蓝·出行更准·地图导航
**设计原则**：
- 科技驱动：导航蓝 出行更准 地图导航[0]传递品牌基因，界面体现未来感
...
### 渐变色
- 主色渐变：`linear-gradient(135deg, #0D96FF, #269FFF)`
- 科技渐变：`linear-gradient(90deg, #0D96FF, #00B42A)`
...
| 类型 | 高度 | 圆角 | 字号 | 背景色 |
|------|------|------|------|--------|
| 主要按钮 | 44px | 22px | 16px/500 | #0D96FF |
...
:root {
  --amap-primary: #0D96FF;
  --amap-primary-50: #E6F4FF;
  --amap-primary-100: #B3DEFF;
  --amap-primary-200: #80C7FF;
  --amap-primary-300: #4DB1FF;
  --amap-primary-400: #269FFF;
  --amap-primary-500: #0D96FF;
  --amap-primary-600: #0B7ED9;
  --amap-primary-700: #0968B3;
  --amap-primary-800: #07528C;
  --amap-primary-900: #053C66;
  --amap-success: #00B42A;
  --amap-warning: #FF7D00;
  --amap-error: #F53F3F;
  --amap-text-title: #1D2129;
  --amap-text-body: #4E5969;
  --amap-text-secondary: #86909C;
  --amap-text-placeholder: #C9CDD4;
  --amap-border: #E5E6EB;
  --amap-bg-page: #F7F8FA;
  --amap-bg-card: #FFFFFF;
  --amap-radius-sm: 4px;
  ...
  --amap-spacing-xs: 4px;
  --amap-spacing-sm: 8px;
  --amap-spacing-md: 12px;
  --amap-spacing-lg: 16px;
  --amap-spacing-xl: 24px;
  --amap-spacing-2xl: 32px;
}
``
