...
**价值观**：远景蓝·造每个人的精品车
**设计原则**：
- 科技驱动：远景蓝 精品车 多品牌矩阵[0]传递品牌基因，界面体现未来感
...
``css
:root {
  --geely-primary: #005BAC;
  --geely-primary-50: #E6F0FA;
  --geely-primary-100: #B3D4F0;
  --geely-primary-200: #80B8E6;
  --geely-primary-300: #4D9CDC;
  --geely-primary-400: #2684D2;
  --geely-primary-500: #005BAC;
  --geely-primary-600: #004D91;
  --geely-primary-700: #003E76;
  --geely-primary-800: #002F5C;
  --geely-primary-900: #002041;
  --geely-success: #00B42A;
  --geely-warning: #FF7D00;
  --geely-error: #F53F3F;
  --geely-text-title: #1D2129;
  --geely-text-body: #4E5969;
  --geely-text-secondary: #86909C;
  --geely-text-placeholder: #C9CDD4;
  --geely-border: #E5E6EB;
  --geely-bg-page: #F7F8FA;
  --geely-bg-card: #FFFFFF;
  --geely-radius-sm: 4px;
  --geely-radius-md: 8px;
  --geely-radius-lg: 12px;
  --geely-radius-xl: 16px;
  --geely-spacing-xs: 4px;
  --geely-spacing-sm: 8px;
  --geely-spacing-md: 12px;
  --geely-spacing-lg: 16px;
  --geely-spacing-xl: 24px;
  --geely-spacing-2xl: 32px;
}
``
