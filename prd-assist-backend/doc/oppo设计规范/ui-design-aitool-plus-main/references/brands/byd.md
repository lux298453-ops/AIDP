...
> 新能红·Build Your Dreams·技术为王 | 主色：#C41230

---

## 一、设计价值观与原则

**价值观**：新能红·Build Your Dreams·技术为王
**设计原则**：
- 科技驱动：新能红 技术为王 新能源[0]传递品牌基因，界面体现未来感
...
- 科技渐变：`linear-gradient(90deg, #C41230, #00B42A)`
...
| 类型 | 高度 | 圆角 | 字号 | 背景色 |
|------|------|------|------|--------|
| 主要按钮 | 44px | 22px | 16px/500 | #C41230 |
...
:root {
  --byd-primary: #C41230;
  --byd-primary-50: #FCE8EB;
  --byd-primary-100: #F5B8C2;
  --byd-primary-200: #ED8DA0;
  --byd-primary-300: #E5627D;
  --byd-primary-400: #D93D58;
  --byd-primary-500: #C41230;
  --byd-primary-600: #A30E28;
  --byd-primary-700: #820A20;
  --byd-primary-800: #610718;
  --byd-primary-900: #450410;
  --byd-success: #00B42A;
  --byd-warning: #FF7D00;
  --byd-error: #F53F3F;
  --byd-text-title: #1D2129;
  --byd-text-body: #4E5969;
  --byd-text-secondary: #86909C;
  --byd-text-placeholder: #C9CDD4;
  --byd-border: #E5E6EB;
  --byd-bg-page: #F7F8FA;
  --byd-bg-card: #FFFFFF;
  --byd-radius-sm: 4px;
